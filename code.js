...
function newElement() {
    ...
    li.innerHTML = (inputValue) + '<font color="' + priorityMap[priority].value + '">' + priority + '</font>';
    if ((document.getElementById("myTODO").value.length < 6) || (document.getElementById("myTODO").value.length > 42)) {
